...
import org.authentication.ambientaudio.Complex;
...
public class AudioFingerprintTest {
	...
	public AudioFingerprintTest(Context context/*, Handler handler, Timer timer*/) {
		mContext = context;
		//mHandler = handler;
		//mTimer = timer;
		mState = STATE_NONE;
	...
	public void initialize() {
		...
		sampling_time = Integer.parseInt(pref.getString("sampling_time", Integer.toString(AudioFingerprintTest.DEFAULT_SAMPLING_TIME)));
		delayed_time = 	Integer.parseInt(pref.getString("delayed_time", Integer.toString(AudioFingerprintTest.DEFAULT_DELAYED_TIME)));
    	redundant_time = Integer.parseInt(pref.getString("redundant_time", Integer.toString(AudioFingerprintTest.DEFAULT_REDUNDANT_TIME)));
    	sampling_rate = Integer.parseInt(pref.getString("sampling_rate", Integer.toString(AudioFingerprintTest.DEFAULT_SAMPLING_RATE)));
    	frame_length =  Integer.parseInt(pref.getString("frame_length", Integer.toString(AudioFingerprintTest.DEFAULT_FRAME_LENGTH)));
    	band_length = 	Integer.parseInt(pref.getString("band_length", Integer.toString(AudioFingerprintTest.DEFAULT_BAND_LENGTH)));
		...
		AudioFingerprintTest.fingerprintBits = (nFrame-1)*(nBand-1);
